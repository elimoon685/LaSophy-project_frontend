...
<p className="font-libre text-xl indent-8">We welcome anyone with an independent perspective on history—people who can form their own systematic way of understanding the past. You should neither overlook large-scale historical trends, nor become obsessed with trivial, microscopic events. You should be able to use your own framework to judge the nature of historical events, to anticipate historical developments, and even to interpret the political behaviour of contemporary states.</p>
<br/>
<p className="font-libre text-xl indent-8">You should also be capable of understanding the language and context of different civilizations and intellectual traditions—for example, Qing-dynasty Confucian thought, modern Marxism, Islamic civilization, contemporary Europe, modern Britain, the U.S. Democratic Party, the Republican Party, and so on.</p>
<br/>
<p className="font-libre text-xl indent-8">If you feel you meet these criteria, you may send your own work to <u><strong>linsophymoon@gmail.com</strong></u>
...
<br/>
<p className="font-libre text-xl indent-8">We look forward to reading your work!</p>
</div>
</div>
)
}
